...
deposit money, withdraw money, and display the account balance. Ensure tgat tge account balance
cannot be accessed directly from outside the class.  Write a program to cteate an instance of the
...
account = BankAccount(account_number="123456789",
                      account_holder_name="Hati prabu",
